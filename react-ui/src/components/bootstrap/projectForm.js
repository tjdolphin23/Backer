...
class ProjectForm extends Component {
	...
	handleFormSubmit = event => {
		...
		const {username, product, companyName, investmentNeeded, percentGiving, productSummary, problemSolution, industry, competition, marketSize, marketTrends, differentiators, grossSales, grossCosts, netProfits, otherInvestors, numberEmployees, targetMarket, salePrice, costPrice, features, productPatent, other, image} = this.state;
		this.setState({
			username: "",
            product: "",
            companyName: "",
	...
	render () {
		return (
			<div className="startBox col-12 col-lg-5">
